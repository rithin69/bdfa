  ...
  if (!city) {
    return (
      <div style={{ minHeight: '100vh', background: '#F7F4F0', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '24px' }}>
        ...
        <Link to="/" style={{ background: '#0ABAB5', padding: '14px 32px', color: '#1C2B2B', fontSize: '11px', letterSpacing: '2.5px', fontWeight: 700, textTransform: 'uppercase', textDecoration: 'none', display: 'inline-block' }}>
          Back to Home
        </Link>
      </div>
    )
