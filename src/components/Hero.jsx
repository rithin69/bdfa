...
export default function Hero() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta property="og:description" content="BDF Architectural supply and install premium bifold doors, sliding doors, aluminium windows and skylights across the UK. Call 01895 439 199 for a free quote." />
