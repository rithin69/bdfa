...
const reasons = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#0ABAB5" strokeWidth="1.5" className="w-5 h-5">
...
const HouseSketch = () => (
  <svg viewBox="0 0 400 500" fill="none" className="w-4/5 h-4/5 opacity-60">
    <polyline points="200,30 20,160 380,160" stroke="#0ABAB5" strokeWidth="2.5" strokeLinejoin="miter"/>
    <rect x="20" y="160" width="360" height="280" stroke="#0ABAB5" strokeWidth="2"/>
    <line x1="20" y1="160" x2="100" y2="220" stroke="#0ABAB5" strokeWidth="1.5"/>
    <line x1="380" y1="160" x2="300" y2="220" stroke="#0ABAB5" strokeWidth="1.5"/>
    <line x1="20" y1="440" x2="100" y2="380" stroke="#0ABAB5" strokeWidth="1.5"/>
    <line x1="380" y1="440" x2="300" y2="380" stroke="#0ABAB5" strokeWidth="1.5"/>
    <rect x="100" y="220" width="200" height="160" stroke="#0ABAB5" strokeWidth="1.5"/>
    <rect x="160" y="320" width="80" height="120" stroke="#0ABAB5" strokeWidth="1.5"/>
    <rect x="50" y="240" width="36" height="36" stroke="#0ABAB5" strokeWidth="1"/>
    <rect x="314" y="240" width="36" height="36" stroke="#0ABAB5" strokeWidth="1"/>
    {[120,200,280].map(x => <line key={x} x1={x} y1="160" x2={x} y2="440" stroke="#0ABAB5" strokeWidth="0.5" opacity="0.3"/>)}
    {[300,360].map(y => <line key={y} x1="20" y1={y} x2="380" y2={y} stroke="#0ABAB5" strokeWidth="0.5" opacity="0.3"/>)}
    <rect x="260" y="40" width="20" height="50" stroke="#0ABAB5" strokeWidth="1.5"/>
    <line x1="10" y1="160" x2="10" y2="440" stroke="#0ABAB5" strokeWidth="0.8" opacity="0.35"/>
    <line x1="6" y1="160" x2="14" y2="160" stroke="#0ABAB5" strokeWidth="1" opacity="0.35"/>
    <line x1="6" y1="440" x2="14" y2="440" stroke="#0ABAB5" strokeWidth="1" opacity="0.35"/>
    <line x1="20" y1="455" x2="380" y2="455" stroke="#0ABAB5" strokeWidth="0.8" opacity="0.35"/>
    <line x1="20" y1="451" x2="20" y2="459" stroke="#0ABAB5" strokeWidth="1" opacity="0.35"/>
    <line x1="380" y1="451" x2="380" y2="459" stroke="#0ABAB5" strokeWidth="1" opacity="0.35"/>
  </svg>
)
            ...
            {reasons.map((r, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[11px] text-bdf-white/65 leading-loose font-light">
                    {r.desc}
                  </div>
                </div>
              </div>
